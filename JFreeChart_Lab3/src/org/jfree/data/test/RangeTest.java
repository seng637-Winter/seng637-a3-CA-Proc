...
public class RangeTest {
    ...
    public void combineIgnoringNaNFirstRangeNaNLower() {
    	...
    	Range combinedRange = new Range(5.0, 21.0);
    	assertEquals("combineIgnoringNan(Range[NaN, 5.0], Range[10.0,21.0]) should return Range[5.0, 21.0]", 
    ...
    public void combineIgnoringNaNSecondRangeNaNUpper() {
    	...
    	Range combinedRange = new Range(5.0, 21.0);
    	assertEquals("combineIgnoringNan(Range[5.0, NaN], Range[10.0,21.0]) should return Range[5.0, 21.0]", 
    ...
    public void expandToIncludeNewValueBelow() {
    	Range expectedRange = new Range(0.0, 21.0);
    	assertEquals("expandToInclude(Range[10,21], 0) should return Range[0,21]", expectedRange, Range.expandToInclude(posPosRange, 0.0));
    }
    ...
    public void expandByDouble() {
    	...
    	Range expectedRange = new Range(-10.0, 10.0);
    	assertEquals("expand(Range[0,10],100,0) should return Range[-10,10]",expectedRange, Range.expand(actualRange, 100, 0));
    }
    ...
    public void expandByNegativeMargin() {
    	...
    	assertEquals("expand(Range[0,10],-200,0) should return Range[10,20]",expectedRange, Range.expand(actualRange, -200, 0));
    }
    ...
    public void shiftUpwardsAcrossZero() {
    	...
    	Range expectedRange = new Range(1, 3.0);
    	assertEquals("shift(Range[-5,-3], 6) should return Range[1,3]", expectedRange, Range.shift(actualRange, 6));
    }
